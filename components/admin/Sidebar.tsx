...
const Icons: Record<string, React.ReactNode> = {
  ...
  [AdminMenuItem.SelectedCandidates]: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /><path d="M19 11l-4 4-2-2" /></svg>,
  ...
  [AdminMenuItem.PartnerTrackApplicants]: <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>,
  [AdminMenuItem.PartnerInterviewLineups]: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>,
  ...
  [AdminMenuItem.PartnerPostJob]: <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /></svg>,
...
const shortLabels: Record<string, string> = {
  ...
  [AdminMenuItem.SelectedCandidates]: 'Selected Candidates',
  ...
  [AdminMenuItem.Payslips]: 'Payslips',
  [AdminMenuItem.EmployeeManagement]: 'Employee Management',
  [AdminMenuItem.MyProfile]: 'My Account', // Changed 'My Profile' to 'My Account'
  [AdminMenuItem.PartnerTrackApplicants]: 'Track Applicants',
  [AdminMenuItem.PartnerInterviewLineups]: 'Interview Lineups',
  [AdminMenuItem.PartnerActiveCandidates]: 'Active Candidates',
  [AdminMenuItem.ManageSupervisors]: 'Manage Supervisors',
  [AdminMenuItem.PartnerPostJob]: 'Post Job / Requirement',
  [AdminMenuItem.PartnerInvoices]: 'Partner Invoices',
  [AdminMenuItem.PartnerHelpCenter]: 'Partner Help Center',
};

const Sidebar: React.FC<SidebarProps> = ({ activeItem, onItemClick, userType, isOpen, onClose }) => {
  ...
  const NavItem = ({ label, isHeader }: { label?: AdminMenuItem | string, isHeader?: boolean }) => {
    ...
    let displayText = shortLabels[itemLabel] || itemLabel;
    if (itemLabel === AdminMenuItem.MyProfile && (userType === UserType.TEAM || userType === UserType.TEAMLEAD)) {
        displayText = 'My Info';
    }
  ...
  const getMenuContent = () => {
    if (userType === UserType.ADMIN) {
      return (
       ...
       return (
        <>
          <NavItem label={AdminMenuItem.Dashboard} />
          <NavItem label={AdminMenuItem.SelectedCandidates} />
        ...
        return (
          <>
            <NavItem label={AdminMenuItem.Dashboard} />
            <NavItem label={AdminMenuItem.PartnerPostJob} />
            <NavItem label={AdminMenuItem.PartnerTrackApplicants} />
    ...
    } else if (userType === UserType.TEAM) { // New limited view for "Hire Yourself" users
        return (
            <>
              <NavItem label={AdminMenuItem.ManageJobBoard} />
              <NavItem label={AdminMenuItem.AllCandidates} />
        ...
        return (
            <>
              ...
              <NavItem label={AdminMenuItem.SelectionDashboard} />
              <NavItem label={AdminMenuItem.PartnerTrackApplicants} />
              <NavItem label={AdminMenuItem.StoreAttendance} />
              <NavItem label={AdminMenuItem.MyProfile} />
            </>
        );
    }
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside className={`
        fixed lg:static inset-y-0 left-0 w-64 bg-white border-r border-gray-200 text-gray-800 flex flex-col shadow-lg lg:shadow-none h-full z-50 transform transition-transform duration-300 ease-in-out
        ${isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}
      `}>
        <div className="flex items-center justify-between mb-4 px-6 pt-6 pb-2">
